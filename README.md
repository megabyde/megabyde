...
Copyright 2020-2026 Yury Bayda.

The posts in this repository are licensed under [CC BY 4.0](LICENSE). The files under
[`assets/`](assets) are licensed under the [MIT License](assets/LICENSE).
